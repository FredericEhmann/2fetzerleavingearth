...
public class AllyShooting : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        intervalReset = 0.2f;
        shootingInterval4 = 0.5f;
        shootingInterval3 = 0.4f;
        shootingInterval2 = 0.3f;
        if ("Mom".Equals(allyName))
        {
            color = Color.blue;
        }
        else if ("Dad".Equals(allyName)) {
            color = Color.red;
        }
    ...
    private void Shoot()
    {
...

        {
            if (shootingInterval2 <= 0)
            {
                ...
                bullet1.gameObject.GetComponent<SpriteRenderer>().color = color;
                ...
                bullet4.gameObject.GetComponent<SpriteRenderer>().color = color;
        ...
        }
        {
            if (shootingInterval3 <= 0)
            {
                ...
                bullet2.gameObject.GetComponent<SpriteRenderer>().color = color;
                ...
                bullet5.gameObject.GetComponent<SpriteRenderer>().color = color;
        ...
        }
        {
            if (shootingInterval4 <= 0)
            {
                ...
                bullet3.gameObject.GetComponent<SpriteRenderer>().color = color;
                ...
                bullet6.gameObject.GetComponent<SpriteRenderer>().color = color;
